...
print("✅ Railway final tayyorlandi")
print("✅ start.py yaratildi: web + bot bitta service ichida ishlaydi")
print("✅ DB va uploads /data volume bilan ishlaydi")
print("✅ /uploads route qo'shildi")
'@

$fixPath = "$root\railway_final_prepare.py"
...
Write-Host ""
Write-Host "✅ Railway final tayyorlov tugadi!" -ForegroundColor Green
Write-Host ""
