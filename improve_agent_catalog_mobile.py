...
# 1) Valyuta yozuvlarini "СЃРѕРјРѕРЅ" ga o'tkazish
replacements = {
    "СЃРѕРјРѕРЅ": "СЃРѕРјРѕРЅ",
    "СЃРѕРјРѕРЅ": "СЃРѕРјРѕРЅ",
    "СЃРѕРјРѕРЅ": "СЃРѕРјРѕРЅ",
    "somon": "somon",
    "somon": "somon",
...
for js_file in js_candidates:
    if js_file.exists():
        ...
        old = js
        js = js.replace("СЃРѕРјРѕРЅ", "СЃРѕРјРѕРЅ")
        js = js.replace("СЃРѕРјРѕРЅ", "СЃРѕРјРѕРЅ")
        js = js.replace("СЃРѕРјРѕРЅ", "СЃРѕРјРѕРЅ")
        if js != old:
...
print("\nOK: Agent katalog sahifasi yaxshilandi, valyuta 'СЃРѕРјРѕРЅ' bo'ldi, +/- mobilga moslashtirildi.")
